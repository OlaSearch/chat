                  ...
                  <div className="ola-answer-keyvalue">
                    {fields.map(({ label, value }, idx) => {
                      let klass = classNames(
                        'ola-answer-row',
                        `ola-answer-row-${label}`
                      )
                      return (
                        <div className={klass} key={idx}>
                          <div className="ola-answer-value">{value}</div>
                        </div>
                      )
                    })}
                  </div>
