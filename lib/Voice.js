  ...
  _createClass(Voice, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { onClick: this.handleSpeechStart, className: _style2.default.dynamic([['4145338918', [this.props.theme.primaryColor]]]) + ' ' + (containerKlass || '')
        },
        _react2.default.createElement(
          'button',
          { type: 'button', className: _style2.default.dynamic([['4145338918', [this.props.theme.primaryColor]]]) + ' ' + (klass || '')
          },
          ...
          isRecording && showListening ? _react2.default.createElement(
            'span',
            {
              className: _style2.default.dynamic([['4145338918', [this.props.theme.primaryColor]]]) + ' ' + 'olachat-mic-listening'
            },
            translate('chat_listening', {}, true)
          ) : null,
          showLoadingIndicator && _react2.default.createElement('span', {
            className: _style2.default.dynamic([['4145338918', [this.props.theme.primaryColor]]]) + ' ' + 'olachat-mic-loader'
          })
        ),
        _react2.default.createElement(_style2.default, {
          styleId: '4145338918',
          css: '.olachat-mic.__jsx-style-dynamic-selector{color:' + this.props.theme.primaryColor + ';}',
          dynamic: [this.props.theme.primaryColor]
        })
      );
    }
  }]);
