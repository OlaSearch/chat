...
var _mic = require('@olasearch/icons/lib/mic');

var _mic2 = _interopRequireDefault(_mic);

var _micOff = require('@olasearch/icons/lib/mic-off');
  ...
  _createClass(Voice, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { onClick: this.handleSpeechStart, className: _style2.default.dynamic([['2786824494', [this.props.theme.primaryColor, this.props.theme.dangerColor]]]) + ' ' + (containerKlass || '')
        },
        _react2.default.createElement(
          'button',
          { type: 'button', className: _style2.default.dynamic([['2786824494', [this.props.theme.primaryColor, this.props.theme.dangerColor]]]) + ' ' + (klass || '')
          },
          isRecording ? _react2.default.createElement(_mic2.default, { size: iconSize }) : _react2.default.createElement(_mic2.default, { size: iconSize }),
          isRecording && showListening ? _react2.default.createElement(
            'span',
            {
              className: _style2.default.dynamic([['2786824494', [this.props.theme.primaryColor, this.props.theme.dangerColor]]]) + ' ' + 'olachat-mic-listening'
            },
            translate('chat_listening', {}, true)
          ) : null,
          showLoadingIndicator && _react2.default.createElement('span', {
            className: _style2.default.dynamic([['2786824494', [this.props.theme.primaryColor, this.props.theme.dangerColor]]]) + ' ' + 'olachat-mic-loader'
          })
        ),
        _react2.default.createElement(_style2.default, {
          styleId: '2786824494',
          css: '.olachat-mic.__jsx-style-dynamic-selector{color:' + this.props.theme.primaryColor + ';}.olachat-mic.olachat-mic-isrecording.__jsx-style-dynamic-selector{color:' + this.props.theme.dangerColor + ';}',
          dynamic: [this.props.theme.primaryColor, this.props.theme.dangerColor]
        })
      );
    }
  }]);
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, null)(_core.Decorators.withTranslate(Voice));