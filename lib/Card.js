...
var _AnswerChart = require('olasearch/lib/components/Answer/AnswerChart');

var _AnswerChart2 = _interopRequireDefault(_AnswerChart);
...
var Card = function Card(_ref) {
  ...
  function pickTemplate(template) {
    ...
    switch (template) {
      ...
      case 'line_chart':
        return _react2.default.createElement(_AnswerChart2.default, {
          data: card
        });
