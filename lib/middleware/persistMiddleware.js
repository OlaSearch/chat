...
exports.default = function (_ref) {
  ...
  return (0, _core.createPersistMiddleware)({
    namespace: namespace,
    types: [_ActionTypes2.default.REQUEST_BOT_SUCCESS, _ActionTypes2.default.HIDE_INVITE, _ActionTypes2.default.SHOW_INVITE],
...
var KEYS_TO_STORE = ['messages', 'isBotActive', 'inviteVisible'];
