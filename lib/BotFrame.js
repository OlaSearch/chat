...
var OLACHAT_MESSAGE_ELEMENT = '.olachat-message-reply';
...
var BotFrame = function (_React$Component) {
  ...
  function BotFrame(props) {
    ...
    _this.checkForListener = function () {
      ...
      if (_this.messagesEl && !_this.addedMessageClickEvent) {
        _this.messagesEl.addEventListener('click', _this.clickListener);
        _this.addedMessageClickEvent = true;
      }
    ...
    _this.clickListener = function (e) {
      ...
      if (!(0, _utils.closest)(_this.innerDoc, e.target, OLACHAT_MESSAGE_ELEMENT)) return;
      e.preventDefault();
