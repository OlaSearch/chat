  ...
  _createClass(BotFrame, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        { style: frameStyles, head: this.props.head, id: _Settings.OLACHAT_IFRAME_ID, initialContent: this.props.initialContent },
        _react2.default.createElement(_Bot2.default, _extends({}, this.props, { iFrame: true, onBubbleClick: this.handleBubbleClick }))
      );
    }
  }]);
...
BotFrame.defaultProps = {
  ...
  activeStyle: {},
  initialContent: '<!DOCTYPE html><html><head><base target="_parent"></head><body class="olachat-body"><div class="frame-root"></div></body></html>'
};
