...
var _InviteNotification = require('./InviteNotification');

var _InviteNotification2 = _interopRequireDefault(_InviteNotification);
...
var BotFrame = function (_React$Component) {
  ...
  _createClass(BotFrame, [{
    ...
    value: function componentDidMount() {
      /* On Mount */
      this.props.onMount && this.props.onMount(document.getElementById(_Settings.OLACHAT_IFRAME_ID).contentDocument);
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          bubbleProps = _props.bubbleProps,
          inviteVisible = _props.inviteVisible;

      /* Check if chatbot label is present */

      var showBubbleLabel = this.props.isDesktop ? bubbleProps && !!bubbleProps.label : false;
      ...
      var frameStyles = _extends({}, iframeStyle, isBotActive ? _extends({
        ...
        height: _Settings.BUBBLE_FULL_HEIGHT
      } : {
        bottom: _Settings.BUBBLE_SPACING,
        top: 'auto',
        right: _Settings.BUBBLE_SPACING,
        left: 'auto',
      ...
      return _react2.default.createElement(
        ...
        inviteVisible ? _react2.default.createElement(
          _reactFrameComponent2.default,
          {
            style: _extends({}, iframeStyle, {
              position: 'fixed',
              bottom: 86,
              right: 20,
              width: 300,
            ...
            id: _Settings.OLACHAT_INVITE_IFRAME_ID,
            initialContent: this.props.initialContent,
            title: 'Ola Chat'
          },
          _react2.default.createElement(_InviteNotification2.default, _extends({}, this.props, { iFrame: true }))
        ) : null
      );
    }
  }]);
...
BotFrame.defaultProps = {
  width: _Settings.BUBBLE_FULL_WIDTH_DESKTOP,
  widthMobile: _Settings.BUBBLE_FULL_WIDTH_MOBILE,
  widthActive: _Settings.BOT_WIDTH_ACTIVE /* 410 */
  , height: _Settings.BUBBLE_FULL_HEIGHT,
  heightActive: '100%' /* 620 */
  , /* Flag to add the chatbot as an inline element */
  inline: false,
  zIndex: _Settings.BOT_ZINDEX,
  iframeStyle: {
    border: 'none',
    maxWidth: '100%'
  },
...
exports.default = (0, _reactRedux.connect)(mapStateToProps)(_core.Decorators.withLogger(BotFrame));