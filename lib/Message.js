  ...
  _createClass(Message, [{
    ...
    value: function render() {
      ...
      if (results && results.length) {
        isSearchActive = true;
        /* Bot reply */
        text = '<p>\n        ' + (search ? suggestedTerm ? 'We could find results for ' + originalQuery + '. Showing results for <mark class=\'ola-mark\'>' + suggestedTerm + '</mark> instead' : search.title : 'Here are some results I found') + '\n      </p>';
      } else {
        /* No results */
