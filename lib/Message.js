  ...
  _createClass(Message, [{
    ...
    value: function render() {
      ...
      if (results && results.length) {
        isSearchActive = true;
        /* Bot reply */
        text = '<p>\n        ' + (search ? suggestedTerm ? translate('chat_could_not_find', {
          originalQuery: originalQuery,
          suggestedTerm: suggestedTerm
        }) : search.title : translate('chat_here_some_result')) + '\n      </p>';
      } else {
        /* No results */
        text = text || '<p>' + (search ? search.no_result : translate('chat_sorry_no_result')) + '</p>';
      }
