...
var Message = function (_React$Component) {
  ...
  _createClass(Message, [{
    ...
    value: function render() {
       ...
       *
       */
      var needsLocation = isActive ? message.location : message.location;
      ...
      if (results && results.length) {
        isSearchActive = true;
        /* Bot reply */
        text = '<p>\n        ' + (search ? suggestedTerm ? translate('could_not_find', { originalQuery: originalQuery, suggestedTerm: suggestedTerm }) : search.title : translate('here_some_result')) + '\n      </p>';
      } else {
        /* No results */
