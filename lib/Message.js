    ...
    value: function render() {
      ...
      if (isBot) {
        if (results && results.length) {
          ...
          isSearchActive = true;
          text = suggestedTerm !== originalQuery ? translate('chat_could_not_find', { originalQuery: originalQuery, suggestedTerm: suggestedTerm }) : search && search.title ? search.title : translate('chat_here_some_result');
        } else {
