...
function changePage(page) {
  return {
    type: _ActionTypes2.default.CHANGE_BOT_PAGE,
    page: page
  };
}
...
function loadMore(message) {
  return function (dispatch, getState) {
    ...
    if (message.search) {
      q = message.search.q, facet_query = message.search.facet_query;
    ...
    var _currentState$Convers = currentState.Conversation,
        perPage = _currentState$Convers.perPage,
        page = _currentState$Convers.page;
