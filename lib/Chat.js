  ...
  _createClass(Chat, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        {
          className: 'jsx-1493022031 ' + _style2.default.dynamic([['1517151259', [theme.chatLinkColor, theme.chatLinkHoverColor, theme.chatFontFamily]], ['2254658243', [theme.primaryColor, theme.chatFontFamily]]]) + ' ' + 'olachat'
        },
        ...
        _react2.default.createElement(_style2.default, {
          styleId: '2254658243',
          css: '.olachat.__jsx-style-dynamic-selector .ola-link-load-more{color:' + theme.primaryColor + ';background:transparent;}.olachat.__jsx-style-dynamic-selector .olachat-input-textarea,.olachat.__jsx-style-dynamic-selector .olachat-query-suggestion,.olachat.__jsx-style-dynamic-selector button{font-family:' + theme.chatFontFamily + ';}',
          dynamic: [theme.primaryColor, theme.chatFontFamily]
        }),
        _react2.default.createElement(_style2.default, {
          styleId: '1493022031',
          css: '.olachat.jsx-1493022031 .ola-share-links{display:block;}@media screen and (-ms-high-contrast:active), (-ms-high-contrast:none){img[src$=\'.svg\']{width:100%;}.olachat-body{overflow:hidden;}.olachat{border:1px #ccc solid;}}'
        })
      );
    }
  }]);
