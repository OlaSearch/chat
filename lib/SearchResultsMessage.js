  ...
  _createClass(SearchResultsMessage, [{
    ...
    value: function render() {
      ...
      var bookmarks = AppState.bookmarks,
          ...
          isLoadingMc = AppState.isLoadingMc;
      ...
      /* No search text, */
      if (!msgText || mc && mc.answer && mc.answer.confidence > 0.2 || isLoadingMc && isActive) return null;

      var _search = search,
          title = _search.title,
          noResultsText = _search.no_result,
          baseUrl = _search.base_url;
