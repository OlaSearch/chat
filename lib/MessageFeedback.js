...
var MessageFeedback = function (_React$Component) {
  ...
  function MessageFeedback() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = MessageFeedback.__proto__ || Object.getPrototypeOf(MessageFeedback)).call.apply(_ref, [this].concat(args))), _this), _this.handlePositive = function () {
...
module.exports = (0, _reactRedux.connect)(null, {
  activateFeedback: _actions.activateFeedback,
  disabledFeedback: _actions.disabledFeedback,
  setFeedbackMessage: _actions.setFeedbackMessage,
  setFeedbackRating: _actions.setFeedbackRating,
  logFeedback: _actions.logFeedback,
