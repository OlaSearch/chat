    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'button',
          { type: 'button', onClick: this.handlePositive, className: 'olachat-feedback-positive' },
          _react2.default.createElement('span', { className: 'emoji-thumbs-up' })
        ),
        _react2.default.createElement(
          'button',
          { type: 'button', onClick: this.handleNegative, className: 'olachat-feedback-negative' },
