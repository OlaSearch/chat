...
var Input = function (_React$Component) {
  ...
  _createClass(Input, [{
    ...
    value: function render() {
      ...
      var classes = (0, _classnames2.default)('olachat-footer', {
        'olachat-footer-focused': isFocused
      });
      return _react2.default.createElement(
        'form',
        { onSubmit: this.onFormSubmit, className: _style2.default.dynamic([['709828064', [theme.primaryColor, theme.primaryColor, theme.primaryColor]]]) + ' ' + (classes || '')
        },
        ...
        _react2.default.createElement(
          'div',
          {
            className: _style2.default.dynamic([['709828064', [theme.primaryColor, theme.primaryColor, theme.primaryColor]]]) + ' ' + 'olachat-input'
          },
        ...
        this.props.location ? _react2.default.createElement(_core.GeoLocation, { refreshOnGeoChange: false, showLabel: false }) : null,
        voiceInput && supportsVoice ? _react2.default.createElement(
          'div',
          {
            className: _style2.default.dynamic([['709828064', [theme.primaryColor, theme.primaryColor, theme.primaryColor]]]) + ' ' + 'olachat-input-voice'
          },
        ...
        _react2.default.createElement(
          'button',
          {
            ...
            className: _style2.default.dynamic([['709828064', [theme.primaryColor, theme.primaryColor, theme.primaryColor]]]) + ' ' + 'olachat-submit'
          },
          _react2.default.createElement(_arrowRightCircle2.default, null)
        ),
        _react2.default.createElement(_style2.default, {
          styleId: '709828064',
          css: '.olachat-submit.__jsx-style-dynamic-selector{color:' + theme.primaryColor + ';}.olachat-submit.__jsx-style-dynamic-selector .ola-icon{fill:' + theme.primaryColor + ';}.olachat-submit.__jsx-style-dynamic-selector .ola-icon circle{stroke:' + theme.primaryColor + ';}.olachat-footer.__jsx-style-dynamic-selector .ola-link-geo,.ola-link-geo:hover{background:none;color:red;}',
          dynamic: [theme.primaryColor, theme.primaryColor, theme.primaryColor]
        })
      );
    }
  }]);
