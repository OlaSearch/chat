...
var Input = function (_React$Component) {
  ...
  function Input(props) {
    ...
    _this.handleClickOutside = function (event) {
      ...
      if (!_this.state.suggestedTerm) return;
  ...
  _createClass(Input, [{
    ...
    value: function shouldComponentUpdate(nextProps, nextState) {
      return nextProps.messages !== this.props.messages || nextProps.isTyping !== this.props.isTyping || nextProps.location !== this.props.location || nextState !== this.state;
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        this.props.location ? _react2.default.createElement(_core.GeoLocation, {
          icon: _react2.default.createElement(_navigation2.default, { size: 20 }),
          showLabel: false
        }) : null,
...
exports.default = (0, _reactRedux.connect)(null)((0, _reactOnclickoutside2.default)(Input, {
