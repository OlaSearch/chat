    ...
    _this.onChange = function (event) {
      ...
      if (text) {
        ...
        if (!hasQuickReply || _this.props.isTyping) {
          _this.props.dispatch(_olasearch.Actions.AutoSuggest.executeFuzzyAutoSuggest(text)).then(function (values) {
  ...
  _createClass(Input, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_QuerySuggestions2.default, {
          onChange: this.onSuggestionChange,
          suggestions: suggestions,
          activeIndex: suggestedIndex,
          queryTerm: text
        }),
        _react2.default.createElement(_HelpMenu2.default, null),
