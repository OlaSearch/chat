...
var QuickReplies = function (_Component) {
  ...
  _createClass(QuickReplies, [{
    ...
    value: function render() {
      ...
      var replies = options.map(function (option, idx) {
        return _react2.default.createElement(QuickReplyButton, { key: idx, label: option, handleClick: _this2.handleClick });
      });
...
var QuickReplyButton = function QuickReplyButton(_ref2) {
