...
var QuickReplies = function (_Component) {
  ...
  function QuickReplies() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = QuickReplies.__proto__ || Object.getPrototypeOf(QuickReplies)).call.apply(_ref, [this].concat(args))), _this), _this.handleClick = function (value) {
      _this.props.updateQueryTerm(value);
    ...
    value: function render() {
      ...
      var replies = options.map(function (_ref2, idx) {
        var label = _ref2.label,
            value = _ref2.value;
        return _react2.default.createElement(QuickReplyButton, { key: idx, value: value, label: label, handleClick: _this2.handleClick });
      });
