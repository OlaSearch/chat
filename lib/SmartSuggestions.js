...
var SmartSuggestions = function (_React$Component) {
  _inherits(SmartSuggestions, _React$Component);
  ...
  function SmartSuggestions() {
    ...
    _classCallCheck(this, SmartSuggestions);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = SmartSuggestions.__proto__ || Object.getPrototypeOf(SmartSuggestions)).call.apply(_ref, [this].concat(args))), _this), _this.handleClick = function (label) {
      _this.props.updateQueryTerm(label);
      _this.props.onSubmit();
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }

  _createClass(SmartSuggestions, [{
    key: 'render',
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, { updateQueryTerm: _olasearch.Actions.Search.updateQueryTerm })(SmartSuggestions);