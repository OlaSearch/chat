...
var Bot = function (_Component) {
  ...
  function Bot(props) {
    ...
    _this.toggleActive = function () {
      ...
      _this.setState({
        ...
        _this.props.onBubbleClick && _this.props.onBubbleClick(_this.state.isActive);
        /* Log when chatbot opens or closes */
        _this.props.log({
          eventLabel: _this.state.isActive ? 'open' : 'close',
          eventCategory: 'bot',
          eventType: 'O'
        });
      });
    ...
    if (speechRecognitionProvider) {
      ...
      _this.voiceAdapter = require('./adapters/google').default({ emitter: emitter });
  ...
  _createClass(Bot, [{
    ...
    value: function render() {
      ...
      var component = this.state.isActive ? this.props.vui && supportsVoice && HAS_VOICES ? _react2.default.createElement(_Vui2.default, passProps) : _react2.default.createElement(_Chat2.default, passProps) : null;
...
module.exports = (0, _reactRedux.connect)(mapStateToProps)(_olasearch.Decorators.withLogger(Bot));