...
var Bot = function (_Component) {
  ...
  function Bot(props) {
    ...
    _this.voiceAdapter = (0, _houndify2.default)({ emitter: emitter });
  ...
  _createClass(Bot, [{
    ...
    value: function render() {
      var initialIntent = 'maternity-leave';
      ...
      var component = this.state.isActive ? supportsVoice ? _react2.default.createElement(_Vui2.default, passProps) : _react2.default.createElement(_Chat2.default, passProps) : null;
...
module.exports = (0, _reactRedux.connect)()(Bot);