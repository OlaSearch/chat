...
var Bot = function (_Component) {
  ...
  function Bot(props) {
    ...
    _this.toggleActive = function () {
      ...
      if (_this.props.startOver) {
        _this.props.clearMessages();
        _this.props.clearBotQueryTerm();
      }
    ...
    if (speechRecognitionProvider) {
      ...
      _this.voiceAdapter = require('./adapters/webkit').default({ emitter: emitter });
      /* Lazy load tokens */
  ...
  _createClass(Bot, [{
    ...
    value: function render() {
      ...
      var component = isBotActive ? _react2.default.createElement(_Chat2.default, passProps) : // this.props.vui && supportsVoice && HAS_VOICES ? (
      //   <Vui {...passProps} />
      // ) : (
      //   <Chat {...passProps} />
      // )
      ...
      return _react2.default.createElement(
        'div',
        { className: botClass, style: { opacity: 0 } },
