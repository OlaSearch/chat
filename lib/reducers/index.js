...
var createTypingMsg = function createTypingMsg(msgId) {
  return {
    id: _core.utilities.uuid(),
    msgId: msgId,
    isTyping: true,
    quick_replies: _Settings.EMPTY_ARRAY
  };
};
...
exports.default = function () {
  ...
  switch (action.type) {
    ...
    case _ActionTypes2.default.REQUEST_BOT_SUCCESS:
      ...
      var msg = createMessageObj({ answer: answer, results: results, mc: mc });
      return _extends({}, state, {
        isLoading: false,
    ...
    case _ActionTypes2.default.SHOW_TYPING_INDICATOR:
      return _extends({}, state, {
        messages: [].concat(_toConsumableArray(state.messages), [createTypingMsg(action.msgId)]),
        isTyping: true
      });
