...
var InputFeedback = function (_React$Component) {
  ...
  function InputFeedback(props) {
    ...
    _this.onFormSubmit = function (e) {
      ...
      var lastMessage = _this.props.messages[_this.props.messages.length - 1];
      _this.props.logFeedback(_this.state.message, lastMessage.id);
      _this.setState({
        message: '',
        submitted: true
      }, function () {
  ...
  _createClass(InputFeedback, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'form',
        { className: 'olachat-footer olachat-footer-feedback', onSubmit: this.onFormSubmit },
        ...
        _react2.default.createElement(
          'button',
          { className: 'olachat-button-cancel', type: 'button', onClick: this.cancelFeedback },
          _react2.default.createElement(
            'span',
            null,
